...
namespace BoxGame.Persistence
{
    ...
    public class GameBoard : IGameBoard, ICornerMapper
	{
		...
		{
			List<Box> results  = BoxesCreatedByMove(move, p);
        ...
        public int GetRows() => m_Rows;

        public int GetColumns() => m_Columns;
		...
		public List<Box> BoxesCreatedByMove(IMove move, Player player)
		{
